...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      _______, KC_PAST, KC_7, KC_8, KC_9, KC_PSLS,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, LLOCK, KC_BSPC,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______, KC_PEQL, KC_4, KC_5, KC_6, KC_MINS,                      XXXXXXX, OS_SHFT, OS_ALT, OS_GUI, OS_CTRL, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_ENT, KC_PDOT, KC_1, KC_2, KC_3, KC_PPLS,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ENT,
  //|--------+-------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_COLON, KC_0,  _______,     XXXXXXX, XXXXXXX, TG(NUMPAD)
                                      //`--------------------------'  `--------------------------'
  )
};
// clang-format on
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    rgblight_set_layer_state(L_GAME, layer_state_cmp(state, HMR_QWERTY) || layer_state_cmp(state, ALT_LAYOUT));
#endif

    state = update_tri_layer_state(state, NAV, SYMBOL, MOUSE);

    if (get_highest_layer(state) > ALT_LAYOUT) {
        combo_disable();
    } else {
        combo_enable();
    }
